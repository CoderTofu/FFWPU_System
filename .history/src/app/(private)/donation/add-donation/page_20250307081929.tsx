...
export default function AddDonation() {
  ...
  const handleConfirm = () => {
    ...
    setIsOpen(false);
    // You can handle form submission here or any other logic
  };
  ...
  // Update currency and close dropdown when a selection is made
  ...
  return (
    <div className="w-full mx-auto max-w-[1450px] flex flex-col justify-center items-center bg-white rounded-md shadow-md shadow-black/25 p-4 mt-8">
      {/* Title - DONATIONS */}
      <p className="text-[28px] font-bold mb-8">DONATIONS</p>
            ...
            <div ref={dropdownRef} className="relative">
              ...
              {openDropdown === "Select" && (
                <div className="absolute mt-1 w-full bg-white border border-[#01438F] rounded-md shadow-md">
                  <label
                    className="flex items-center px-3 py-2 hover:bg-gray-200 hover:rounded-sm"
                    onClick={() => handleCurrencySelect("$ USD")}
                  >
                    <input type="radio" name="currency" className="mr-2" required /> $ USD
                  </label>
                  ...
                  >
                    <input type="radio" name="currency" className="mr-2" required /> ₱ PHP
                  </label>
                </div>
              )}
            </div>
