...
export default function AddDonation() {
  ...
  useEffect(() => {
    ...
    const handleMouseDownOutside = (event: MouseEvent) => {
      if (openDropdown && dropdownRef.current && !dropdownRef.current.contains(event.target as Node) && (!dropdownButtonRef.current || !dropdownButtonRef.current.contains(event.target as Node))){
        setOpenDropdown(null);
      }
    };
