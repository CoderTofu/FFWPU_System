            ...
            <div ref={dropdownRef} className="relative">
              <button
                ...
                className="w-[120px] md:w-[140px] lg:w-[394px] h-[36px] border border-[#01438F] rounded-md px-[12px] outline-none
                 bg-white text-[16px] text-gray-600 flex justify-between items-center"
                type="button" 
              >
              ...
              {openDropdown === "Select" && (
                <div className="absolute mt-1 w-full bg-white border border-[#01438F] text-black rounded-md shadow-md">
                  <div
