    ...
    <div>
      ...
      <div className="flex flex-col items-center mt-[63px]">
        <form
          ...
          <div className="flex flex-col w-[394px] mb-4">
            <label className="text-[14px] mb-1">Amount</label>
            <input
              className="w-[394px] max-w-[80%] min-w-[50%] flex-shrink-1 h-[36px] px-2 border border-[#01438F] rounded-md outline-none [&::-webkit-inner-spin-button]:appearance-none"
              type="number"
              required
            />
          </div>
