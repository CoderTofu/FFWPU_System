...
export default function Donation() {
  ...
  // Sort function to handle the sorting
  ...
  const handleSearch = (term: string) => {
    ...
    const handleSort = (key: keyof DataItem, order: "asc" | "desc") => {
      // Create a function to extract the numeric value and currency
      const getAmountInPHP = (amount: string) => {
        ...
        return value * exchangeRates[currency as keyof typeof exchangeRates];
      };
    
      const sortedData = [...originalData].sort((a, b) => {
        const aAmount = getAmountInPHP(a[key as keyof DataItem] as string); // Explicit cast to string
        const bAmount = getAmountInPHP(b[key as keyof DataItem] as string); // Explicit cast to string
