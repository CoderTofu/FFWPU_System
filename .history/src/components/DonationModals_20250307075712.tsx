...
export default function DonationModals({
  ...
  return (
    <div className="flex flex-wrap items-center gap-4 w-full">
      <div className="relative min-w-[250px] sm:w-[300px] md:w-[350px] lg:w-[500px]">
      ...
      <div ref={dropdownRef} className="flex flex-wrap flex-row items-center gap-4 sm:w-auto w-full">
