...
export default function DonationModals({
  ...
  return (
    <div className="flex items-center gap-4 w-full sm:flex-nowrap">
      ...
      <div ref={dropdownRef} className="flex flex-wrap sm:flex-nowrap items-center gap-4 w-full sm:w-auto">
        {["Member ID", "Date", "Church"].map((filter) => (
          <div key={filter} className="relative">
            ...
            {openSortDropdown === filter && (
              <div className="flex flex-wrap sm:flex-nowrap items-center gap-4 sm:w-auto absolute mt-1 w-full bg-white border border-[#01438F] rounded-md shadow-md z-10">
