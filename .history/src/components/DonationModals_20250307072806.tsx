        ...
        {["Member ID", "Date", "Church"].map((filter) => (
          <div key={filter} className="relative">
            <button
              ...
              className="min-w-[px] md:w-[140px] lg:w-[160px] h-10 border border-[#01438F] rounded-md px-3 outline-none bg-white text-gray-600 flex justify-between items-center"
            >
              {filter}
