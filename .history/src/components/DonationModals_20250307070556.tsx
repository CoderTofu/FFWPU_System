...
export default function DonationModals({
  ...
  }, [toggleSortDropdown, toggleCurrencyDropdown]);
  ...
  return (
    <div className="flex flex-wrap items-center gap-4">
      <div className="relative sm:w-[250px] md:w-[300px] lg:w-[500px]">
      ...
      <div ref={dropdownRef} className="flex flex-wrap items-center w-full sm:w-auto gap-4">
