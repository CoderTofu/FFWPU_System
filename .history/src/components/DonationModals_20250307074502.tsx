...
export default function DonationModals({
  ...
  return (
    <div className="flex items-center gap-4 w-full sm:flex-nowrap">
      <div className="relative flex-shrink-0 flex-grow min-w-[250px] sm:w-[300px] md:w-[350px] lg:w-[500px]">
      ...
      <div ref={dropdownRef} className="flex flex-wrap items-center gap-4 w-full sm:w-auto">
        {["Member ID", "Date", "Church"].map((filter) => (
          <div key={filter} className="relative">
            ...
            {openSortDropdown === filter && (
              <div className="flex items-center justify-start w-full sm:w-autoabsolute mt-1 bg-white border border-[#01438F] rounded-md shadow-md z-10">
                <label className="px-3 py-2 hover:bg-gray-200 hover:rounded-sm">
                  <input
                    type="radio"
                    name={filter}
                    className="mr-2"
