      ...
      <section className="my-16 px-5 sm:px-10 md:px-20">
        ...
        <div className="text-[18px] ml-14 mr-14 text-left sm:text-justify leading-9">
          <p>
            ...
            After Korea’s liberation in 1945, he faced brutal persecution under North Korea’s communist regime, enduring imprisonment
            and torture. Despite these hardships, he continued preaching and, during the Korean War, founded the Unification Church
            with a small group of followers. By 1996, the Family Federation had expanded worldwide.
          </p>

          <p className="mt-10">
            The Divine Principle, Father Moon’s core teachings, was originally written for Christians but later broadened to a wider audience. 
            The Family Federation became the first movement of its kind founded by a couple—Father and Mother Moon. Since Father Moon’s passing 
            in 2012, Mother Moon has continued spreading their vision, gaining recognition from major religious groups.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-8 mt-20 drop-shadow-2xl">
          <div className="card w-full sm:w-[442px] bg-white rounded-3xl">
            <div className="img-area flex justify-center">
              <img src="/images/sun myung moon.png" alt="Sun Myung Moon" 
          ...
          <div className="card w-full sm:w-[442px] bg-white rounded-3xl">
            <div className="img-area flex justify-center">
              <img src="/images/hak moon.png" alt="Hak Moon" 
              className="rounded-lg w-full sm:w-[442px] h-auto"/>
            </div>
        ...
        <div className="text-[18px] ml-14 mr-14 text-left sm:text-justify leading-9">
          <p>
            ...
            A better future and lasting peace depend on renewing the family, the foundation of society. Strong families shape 
            future generations, and at their core is the married couple. 
          </p>

          <p className="mt-10">
            Our goal is a world where all people live in love and harmony—with themselves, their families, and their communities—creating 
            a future of peace, freedom, and happiness for all.
          </p>
        </div>
      </section>
