  ...
  return (
    <div className="min-h-screen flex flex-col items-center p-4">
      ...
      <div className="w-full max-w-3x1 p-4 mx-auto mt-3 bg-white rounded-md drop-shadow-lg flex items-center justify-center">
        <p className="text-2xl font-bold uppercase">ADD BLESSING</p>
      </div>
      ...
      <div className="w-full max-w-[1420px] flex justify-center my-3">
        <button className="px-4 py-2 font-bold bg-[#01438F] text-[#FCC346] rounded" onClick={() => setShowModal(true)}>ADD BLESSING</button>
      </div>
