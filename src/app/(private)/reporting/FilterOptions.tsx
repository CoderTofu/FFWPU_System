                ...
                <div className="py-1">
                  ...
                  <label className="flex w-full px-3 py-1 hover:bg-gray-100 cursor-pointer group">
                    <input
                      ...
                      className="mr-1"
                    />
                    <span className="text-sm group-checked:text-[#01438F]">€ EUR</span>
                  </label>
                  <label className="flex w-full px-3 py-1 hover:bg-gray-100 cursor-pointer group">
                    <input
                      type="checkbox"
                      ...
                      className="mr-1"
                    />
                    <span className="text-sm group-checked:text-[#01438F]">¥ JPY</span>
                  </label>
                  <label className="flex w-full px-3 py-1 hover:bg-gray-100 cursor-pointer group">
                    <input
                      type="checkbox"
                      checked={currency === 'KRW'}
                      onChange={() => handleCurrencyChange('KRW')}
                      className="mr-1"
                    />
                    <span className="text-sm group-checked:text-[#01438F]">₩ KRW</span>
                  </label>
                  <label className="flex w-full px-3 py-1 hover:bg-gray-100 cursor-pointer group">
                    <input
                      type="checkbox"
                      checked={currency === 'CNY'}
                      onChange={() => handleCurrencyChange('CNY')}
                      className="mr-1"
                    />
                    <span className="text-sm group-checked:text-[#01438F]">¥ CNY</span>
                  </label>
                </div>
              </div>
            )}
